...
var _ACLCache = require('./ACLCache');
...
var ParseLiveQueryServer = function () {
  ...
  function ParseLiveQueryServer(server, config) {
    ...
    this.aclCache = new _ACLCache.ACLCache({ url: config.redisCacheURL }, config.schemaCacheTTL);
  }
  ...
  _createClass(ParseLiveQueryServer, [{
    ...
    value: function _matchesACL(acl, client, requestId) {
      ...
      return this.sessionTokenCache.getUserId(subscriptionSessionToken).then(function (userId) {
        ...
        return new _node2.default.Promise(function (resolve, reject) {
          ...
          var acl_has_roles = Object.keys(acl.permissionsById).filter(function (key) {
          ...
          try {
            for (var _iterator9 = acl_has_roles[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
              var role = _step9.value;

              roleChecks.push(_this5.aclCache.hasReadAccess(subscriptionSessionToken, role));
            }
          } catch (err) {
          ...
          _node2.default.Promise.when(roleChecks).then(function (roleCheckMatches) {
            var _iteratorNormalCompletion10 = true;
            var _didIteratorError10 = false;
            var _iteratorError10 = undefined;

            try {
              for (var _iterator10 = roleCheckMatches[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
                var roleCheck = _step10.value;
            ...
            _this5.sessionTokenCache.getUserId(subscriptionSessionToken).then(function (userId) {
              ...
              try {
                for (var _iterator11 = roles[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
                  var role = _step11.value;

                  if (acl.getRoleReadAccess(role)) {
                    _this5.aclCache.setHasReadAccess(subscriptionSessionToken, 'role:' + role.get('name'));
                    return resolve(true);
                  }
                }
              } catch (err) {
    ...
    value: function _validateKeys(request, validKeyPairs) {
      ...
      try {
        for (var _iterator12 = validKeyPairs[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
          var _step12$value = _slicedToArray(_step12.value, 2),
              key = _step12$value[0],
              secret = _step12$value[1];
